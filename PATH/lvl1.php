  ...
  <body class="bg-info text-center container">
    ...
    <div style="background-color:#c9c9c9;padding:20px;">
      ...
      <form method="get" action="lvl1.php">
        <input type="text" name="accnt" placeholder="accnt number" value='<?php echo strip_tags($_GET["accnt"]); ?>'/><br>
        <input type="submit" />
    </form>
  </div>
  <!-- <script src="dsc/main.js"></script> -->
...
if(isset($_GET["accnt"])) {
	...
	strip_tags(include($_GET["accnt"]));
		...
		die("You dont have any access dumb!");
	}
}
?>
