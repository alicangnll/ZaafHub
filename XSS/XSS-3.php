...
if (isset($_GET["username"])) {
	...
	echo '<script>document.cookie = "flagxss3=notsameflag2; expires=Thu, '.date("d").' Dec 2032 12:00:00 UTC; path=/";</script>';
	echo "<br>For flag check cookies again :P<br>Your name is ".$user."";
}
 ?>
