...
if (isset($_GET["username"])) {
 	$user = str_replace("<script>", 'xss<script>document.cookie = "flagxss2=notsameflag; expires=Thu, '.date("d").' Dec 2032 12:00:00 UTC; path=/";</script>', $_GET["username"]);
	echo 'Your name is '.$user.'<br>For flag check cookies again :P<script>document.cookie = "flagxss2=notsameflag; expires=Thu, '.date("d").' Dec 2032 12:00:00 UTC; path=/";</script>';
}
?>
